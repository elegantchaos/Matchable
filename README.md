...
[![Test results][tests shield]][actions] [![Latest release][release shield]][releases] [![swift 5.9 shield] ![swift 6.1 shield]][swift] ![Platforms: iOS, macOS, tvOS, visionOS, watchOS][platforms shield]

[release shield]: https://img.shields.io/github/v/release/elegantchaos/Matchable
[platforms shield]: https://img.shields.io/badge/platforms-iOS_macOS_tvOS_visionOS_watchOS-lightgrey.svg?style=flat "iOS, macOS, tvOS, visionOS, watchOS"
[tests shield]: https://github.com/elegantchaos/Matchable/workflows/Tests/badge.svg
[swift 5.9 shield]: https://img.shields.io/badge/swift-5.9-F05138.svg "Swift 5.9"
